...
<!-- <img  class="bg" src="download.jpeg" alt="cutm"> -->
    <div class="container">
        <h1>Feedback Form</h1>
        <P>Enter your details and submit this form to give your Feedback</P>
        <?php
        if($insert == true){
        echo "<p class = 'submitmsg'>Thanks for submitting your form.We are happy for giving feedback for us</p>";
        }
?>
